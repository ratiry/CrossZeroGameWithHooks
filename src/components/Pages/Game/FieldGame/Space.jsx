...
let Space=(props)=>{
  ...
  const MemeFaces=[
    <img src='https://previews.123rf.com/images/profshop/profshop1611/profshop161100014/67808755-vector-lol-happy-guy-meme-face-for-any-design-isolated-eps-10.jpg'/>,//defeat
    <img src='https://w7.pngwing.com/pngs/456/732/png-transparent-sad-character-illustration-internet-meme-sadness-face-crying-jordan-sad-face-meme-miscellaneous-comics-white.png'/>,//victory
    <img src='https://wallpapers.com/images/hd/poker-face-meme-p3u88a2k153h9x9s.jpg'/>
  ]
  let Cases=[
...
if(props.result.player=='zero' || props.result.player=='cross'){
  ...
  let memeFaceCase=null;
  let shouldUseMemes=false;
  if(props.shouldChangeSymbols & props.result.player!=null & props.whose=='zero'){
    shouldUseMemes=true;
  ...
  return(
    <div className={classes.Space}  onClick={onCkickFunction} >
      {shouldUseMemes ? MemeFaces[memeFaceCase]:props.shouldChangeSymbols ? ExtraCases[Case] :Cases[Case]}
      {lineCases[lineCase]}
    </div>
  )
}
